...
import 'package:find_my_work/presentation/notes/note_form/misc/todo_item_presentation_classes.dart';
  ...
  Stream<NoteFormState> mapEventToState(
    ...
    yield* event.map(
      ...
      colorChanged: (e) async* {
        yield state.copyWith(
          note: state.note.copyWith(color: NoteColor(e.colorString)),
          saveFailureOrSuccessOption: none(),
        );
      },
